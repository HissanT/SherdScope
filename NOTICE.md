...
Public License v3.0. SherdScope retains the original project's attribution and
model-download references while adding the Hesban figure-to-table metadata
linking workflow, deterministic local OCR, provenance tracking, review tools,
and related reliability improvements.
